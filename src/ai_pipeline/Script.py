# ==============================================================================
# 🌾 AGRITECH MULTI-AGENT SWARM: LOCAL EXECUTABLE (V10 - CPU FORCED)
# ==============================================================================
import os

# --- THE NUCLEAR KILL-SWITCH ---
# Completely blinds PyTorch to the RTX 5060. MUST execute before importing torch.
...
# ==========================================
# PHASE 2: CORE COGNITIVE ENGINES (CPU FORCED)
# ==========================================
print("🧠 [2/4] Waking Neural Engines (Whisper, Qwen 1.5B, DeBERTa)...")

# 1. Force Whisper to CPU and use int8 quantization
...
# 2. Force Qwen to CPU and use standard 32-bit float precision
...
# ==========================================
async def main():
    # Make sure this is a freshly recorded, genuine audio file!
    audio_file_path = os.path.join(BASE_DIR, "audio1.mp3") 
    
    if not os.path.exists(audio_file_path):
        print(f"\n❌ FATAL: Could not find audio file at {audio_file_path}")
        print("Please place your freshly recorded MP3 file in the script directory and verify the name.")
        return
